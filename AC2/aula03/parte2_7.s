...
lw $t1,TRISB($s0)	#read
ori $t1,$t1,0x0004	#modify (RB2=in)
...
lw $t1,PORTB($s0)	#read input
andi $t1,$t1,0x0004	#clean input

bne $t1,0x0004,endif
xori $s2,$s1,0x0008	#negate msb 0\000
srl $s2,$s2,3		#1000>>0001
sll $s1,$s1,1		#0001 << 0010
